...
urlpatterns = [
    ...
    path('remove/social-link/<slug:slug>/<int:social_id>/', views.social_link_delete, name='social-delete'),
	...
	path('delete/project/<slug:slug>/<int:project_id>/', views.project_delete, name='admin-project-delete'),
	...
	path('delete/work/<slug:slug>/<int:work_id>/', views.delete_work, name='admin-work-delete'),
    path('remove/work-highlight/<slug:slug>/<int:highlight_id>/', views.work_highlight_delete, 
	...
	path('delete/education/<slug:slug>/<int:edu_id>/', views.delete_education, name='admin-education-delete'),
	...
	path('delete/skills/<slug:slug>/<int:skill_id>/', views.skills_delete, name='admin-skills-delete'),
	...
	path('delete/professional/<int:prof_id>/', views.skills_professional_delete, 
	...
	path('delete/services/<slug:slug>/<int:service_id>/', views.services_delete, name='admin-services-delete'),
	...
	path('delete/price/<slug:slug>/<int:price_id>/', views.price_delete, name='admin-price-delete'),

	path('blog/', views.blog, name='admin-blog'),
	path('edit/blog/<slug:slug>/<int:article_id>/', views.edit_blog, name='admin-blog-edit'),
	path('trash/blog/<slug:slug>/<int:article_id>/', views.trash_blog, name='admin-blog-trash'),
